...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    if temperature < 800 and neutrons_emitted > 500:
        return bool(temperature * neutrons_emitted < 500000)
    return False
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    if result < (threshold * 0.90): # this is ok
        return 'LOW'
    if result > (threshold * 1.1): # danger
        return 'DANGER'
    return 'NORMAL'

fail_safe(1000, 30, 5000)
fail_safe(399, 300, 1)
fail_safe(1099, 899, 700)
fail_safe(400, 1101, 1200)
